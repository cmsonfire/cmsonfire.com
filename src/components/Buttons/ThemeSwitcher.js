  ...
  return (
    <Box as={as} {...props}>
      <button
        ...
        class="text-fire-500 dark:text-fire-400 hover:bg-fire-100 dark:hover:bg-fire-700 focus:outline-none focus:ring-4 focus:ring-fire-200 dark:focus:ring-fire-700 rounded-lg text-sm p-1"
      >
        <svg
          id="theme-toggle-dark-icon"
          class={`w-7 h-7 ${
            toggleClass === "dark" ? "" : "hidden"
          } fill-fire-600 dark:fill-fire-200`}
          viewBox="0 0 24 24"
        ...
        <svg
          ...
          class={`w-7 h-7 ${
            toggleClass === "dark" ? "hidden" : ""
          } fill-primary-600 dark:fill-fire-200`}
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
